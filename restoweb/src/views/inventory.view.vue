  ...
  <div id="app">
    ...
    <div class="container">
      <div class="panel panel-left">
        <button @click="showOrderDetails(button)">Platos</button>
        
      </div>
      
      <div class="panel panel-right">
        <button @click="showOrderDetails(button)">Entradas</button>
        
      </div>
    </div>
    <div class="container">
      <div class="panel panel-left">
        <button @click="showOrderDetails(button)">Guarniciones</button>
        
      </div>
      
      <div class="panel panel-right">
        <button @click="showOrderDetails(button)">Bebidas</button>
